...
namespace DIGITALEVALUATION.Controllers
{
    ...
    public class CourseSubjectsController : ControllerBase
    {
        ...
        public CourseSubjectsController(ICourseSubjectService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        [Authorize(Roles = "Admin,User")]
        public async Task<IActionResult> Create(CourseSubjectCreateDto dto)
        {
            var user = GetUser();
        ...
        [HttpPut]
        [Authorize(Roles = "Admin,User")]
        public async Task<IActionResult> Update(CourseSubjectUpdateDto dto)
        {
            var user = GetUser();
