...
namespace DIGITALEVALUATION.Controllers
{
    ...
    {
        private readonly IFacultySubjectService _service;

        public FacultySubjectsController(IFacultySubjectService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        [Authorize(Roles = "Admin,User")]
        public async Task<IActionResult> Create(FacultySubjectCreateDto dto)
        {
            var user = GetUser();
        ...
        [HttpPut]
        [Authorize(Roles = "Admin,User")]
        public async Task<IActionResult> Update(FacultySubjectUpdateDto dto)
        {
            var user = GetUser();
